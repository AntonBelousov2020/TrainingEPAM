...
public class Converter {
     ...
     * @return human entity or exeption
    ...
    public Human convertToHuman(HumanDto humanDto) throws ConverterExeption {
        if (humanDto == null) {
            throw new ConverterExeption("Конвертация не инициализированного экземпляра класса HumanDto");
        }
        Human human;
     ...
     * @return human DTO or exeption
     * @throws ConverterExeption in case of either entry parameter is null
     */
    public HumanDto convertToDto(Human human) throws ConverterExeption {
        if (human == null) {
            throw new ConverterExeption("Конвертация не инициализированного экземпляра класса Human");
        }
        HumanDto humanDto;
